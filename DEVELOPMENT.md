...
```bash
git remote add encore encore://saas-ecommerce-platform-mux2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/saas-ecommerce-platform-mux2/deploys).
...
2. Navigate to Encore Cloud [Github Integration settings](https://app.encore.cloud/saas-ecommerce-platform-mux2/settings/integrations/github)
